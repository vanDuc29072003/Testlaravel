                        ...
                        <div class="border p-3 rounded ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="ThoiGianYeuCau"
                                    value="{{ \Carbon\Carbon::parse($lichSuaChua->yeuCauSuaChua->ThoiGianYeuCau)->format('d/m/Y H:i') }}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="MoTa">Mô Tả</label>
                                <textarea class="form-control" id="MoTa" rows="3"
                                    readonly>{{ $lichSuaChua->yeuCauSuaChua->MoTa }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="ThoiGianBanGiao">Thời Gian Bàn Giao</label>
                                <input type="datetime-local" class="form-control" name="ThoiGianBanGiao"
                                    id="ThoiGianBanGiao" required>
                            </div>

                            <!-- Phần Biện Pháp Xử Lý -->
                            <div class="form-group">
                                <label for="BienPhapXuLy">Biện Pháp Xử Lý</label>
                                <textarea name="BienPhapXuLy" class="form-control" id="BienPhapXuLy" rows="2"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="GhiChu" class="form-control" id="GhiChu" rows="2"
                                    placeholder="Nhập ghi chú"></textarea>
                            </div>
                            <!-- Checkbox Không thay thế linh kiện -->
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="KhongThayLinhKien" required
                                    name="KhongThayLinhKien" value="1" style="transform: scale(1.5);">
                                <label class="form-check-label" for="KhongThayLinhKien"
                                    style="margin-left: 5px; font-size: 30px;">Không thay thế linh kiện</label>
                            </div>
