...
<p><strong>Nhân Viên Tạo (Bộ phận: Kho):</strong> {{ $phieuTra->nhanVienTao->TenNhanVien ?? 'Không xác định' }}</p>
<p><strong>Nhân Viên Nhận (Bộ phận: Kĩ Thuật):</strong> {{ $phieuTra->nhanVienTra->TenNhanVien ?? 'Không xác định' }}</p>
