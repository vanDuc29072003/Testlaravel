      ...
      <div class="row justify-content-center">
        <div class="col-xl-6 col-md-8 col-sm-12">
          <div class="card">
            ...
            <div class="card-body">
              <form id="formLoaiMay" action="{{ route('loaimay.storeLoaiMayfromMay', request()->all()) }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <input type="text" id="MoTa" name="MoTa" class="form-control" placeholder="Vui lòng nhập..." value="{{ old('MoTa') }}" required></input>
                </div>
              </form>
            </div>
