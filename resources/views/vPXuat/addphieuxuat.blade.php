                        ...
                        <div class="border p-3 rounded">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="MaNhanVienTao" name="MaNhanVienTao"
                                    value="{{ old('MaNhanVienTao', Auth::user()->nhanVien->MaNhanVien) }}" readonly style="display: none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="datetime-local" class="form-control" id="NgayXuat" name="NgayXuat"
                                    value="{{ old('NgayXuat', date('Y-m-d\TH:i')) }}" disabled required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="GhiChu" name="GhiChu" rows="3" placeholder="Nhập ghi chú">{{ old('GhiChu') }}</textarea>
                            </div>
